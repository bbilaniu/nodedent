...
This folder separates clinical source material, active product specs, architectural decisions, and archived implementation specs.
...
- [Encrypted backup revision conflict resolution](specs/encrypted-backup-revision-conflict-resolution.md)
...
- [Operative direct restoration workflow](specs/archive/operative-direct-restoration-workflow.md)
...
- [Shared radiology module](specs/archive/shared-radiology-module.md)
