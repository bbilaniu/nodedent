...
export const protocolNodes: Record<string, ProtocolNode> = {
  ...
  "apply-sealer": {
    ...
    requiredInputs: ["Sealer used"],
    contextualFieldIds: ["sealerLabel"],
    ...
    options: [
      { label: "Sealer applied with passive NaviTip withdrawal", nextNodeId: "paper-point-through-sealer", noteEvent: { type: "sealer.applied" }, guards: [{ type: "required", scope: "activeCanal", field: "sealerLabel", message: "Sealer used" }] },
  ...
  "reapply-sealer": {
    ...
    options: [
      { label: "Sealer re-applied", nextNodeId: "seat-gp-cone", noteEvent: { type: "sealer.reapplied" }, guards: [{ type: "required", scope: "activeCanal", field: "sealerLabel", message: "Sealer used" }] },
