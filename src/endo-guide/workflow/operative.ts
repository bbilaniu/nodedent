import type { CapabilityRequirement, WorkflowDefinition, WorkflowModuleCall, WorkflowScope } from "../types";
...
export const sharedFinalRestorationWorkflowId = "shared.final-restoration";
...
export const operativeReadinessCapabilityRequirements: CapabilityRequirement[] = [
  ...
  { name: "anesthesia.adequate", scopeKind: "tooth", message: "Current-visit anesthesia adequacy recorded for the planned tooth" },
  { name: "isolation.established", scopeKind: "tooth", message: "Current-visit isolation established for the planned tooth" },
];
...
export const operativeReadinessModuleCalls: WorkflowModuleCall[] = [
  {
    ...
    title: "Diagnosis",
    reason: "Provides reusable diagnosis and radiograph review context for the operative workflow.",
    requiredCapabilities: operativeReadinessCapabilityRequirements.filter((requirement) =>
      requirement.name === "diagnosis.recorded" || requirement.name === "radiographs.reviewed"
    ),
  ...
  },
  {
    ...
    title: "Anesthesia",
    reason: "Provides current-visit anesthesia adequacy context for the operative workflow.",
    requiredCapabilities: operativeReadinessCapabilityRequirements.filter((requirement) => requirement.name === "anesthesia.adequate"),
    returnedCapabilities: ["anesthesia.adequate"],
  },
  {
    workflowId: sharedIsolationWorkflowId,
    title: "Isolation",
    reason: "Provides current-visit isolation status for the operative workflow.",
    requiredCapabilities: operativeReadinessCapabilityRequirements.filter((requirement) => requirement.name === "isolation.established"),
    returnedCapabilities: ["isolation.established"],
  },
];

export const operativeRestorationModuleCall: WorkflowModuleCall = {
  workflowId: sharedFinalRestorationWorkflowId,
  title: "Final restoration",
  reason: "Records the final restoration capability for the planned tooth and surface scope.",
  requiredCapabilities: [{ name: "finalRestoration.placed", scopeKind: "surface", message: "Final restoration recorded for the planned tooth and surface scope" }],
  returnedCapabilities: ["finalRestoration.placed"],
};
...
export const operativeDirectRestorationWorkflow: WorkflowDefinition = {
  ...
  nodes: {
    "operative-readiness": {
      ...
      chairsideInstruction: "Confirm the planned tooth and surface scope, then reuse recorded diagnosis, radiograph, anesthesia, and isolation capabilities when they satisfy that scope.",
      requiredInputs: ["Tooth", "Surface or surfaces"],
      capabilityRequirements: operativeReadinessCapabilityRequirements,
    ...
    "operative-restoration-record": {
      ...
      moduleCalls: [operativeRestorationModuleCall],
    ...
    "operative-restoration-complete": {
      ...
      capabilityRequirements: operativeRestorationModuleCall.requiredCapabilities,
