...
export function CanalControls({
  ...
  return (
    <SectionCard title="Canal controls" className={className}>
      <div className="grid gap-2 text-sm">
        ...
        <button onClick={() => onManualEvent("canal.completed", "Mark active canal complete", "pathway-complete")} className="rounded-xl border border-green-200 bg-green-50 px-3 py-2 font-semibold text-green-900 hover:bg-green-100">Mark active canal complete</button>
        <button onClick={() => onManualEvent("canal.paused", "Pause active canal", "pathway-complete")} className="rounded-xl border border-slate-200 bg-slate-50 px-3 py-2 font-semibold text-slate-700 hover:bg-slate-100">Pause active canal</button>
        ...
        <button onClick={onStartNextCanal} className="rounded-xl border border-blue-200 bg-blue-50 px-3 py-2 font-semibold text-blue-900 hover:bg-blue-100">Start next incomplete canal</button>
